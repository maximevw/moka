...
public class TestingAccount {
	...
	/**
	 * The balance of the account in WEI at the last call to {@link #checkpoint()}.
	 */
	@Setter(AccessLevel.NONE)
	...
	/**
	 * Gets the current balance of the account in WEI.
	 *
	 * @return The balance of the account in WEI.
	 */
	public BigInteger getBalanceInWei() {
		return getBalance().getValueInWei();
	}
	...
	public BigDecimal getBalanceInEth() {
		return getBalance().getValueIn(Convert.Unit.ETHER);
	}
	...
	public void checkpoint() {
		this.lastBalance = getBalanceInWei();
	}
